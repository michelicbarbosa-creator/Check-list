...
# ================= TAB 4: SAMPLE GARMENT (FOCO EXCLUSIVO EM SIZE) =================
with tab4:
    ...
    # SEÇÃO EXCLUSIVA INDEPENDENTE DE SIZE COM DATA
    with col_sizes:
...
with tab6:
    ...
    # Processamento limpo do resumo 'Size' para o Excel (Production & Shipment removidos)
    sizes_text_summary = ""
    if st.session_state.sizes_history:
